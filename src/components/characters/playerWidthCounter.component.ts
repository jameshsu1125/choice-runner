...
import { Container, Graphics, Image, Sprite } from "../../configs/constants/constants";
...
export default class PlayerWidthCounterComponent extends Container {
    ...
    constructor(
        ...
        this.healthBarFill.setDepth(1002);
    ...
    public setPositionByIndex(index: number, offset: number) {
        ...
        const currentY =
            top + position.y * gap + randomY + this.tweenProperty.y;
