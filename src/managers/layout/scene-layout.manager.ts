...
export default class SceneLayoutManager {
    ...
    public decreaseSupplementCount(
        ...
        this.layoutContainers.firepower.removeFirepowerByName(firepower.name);
        this.layoutContainers.supplement.decreaseSupplementCount(
            supplementName
        );
    }
    ...
    public increaseSupplementCountByType(
        ...
        if (type === "ARMY")
            this.layoutContainers.player.increasePlayersCount(1);
    ...
    public onGameOver(): void {
        ...
        this.scene.tweens.add({
            ...
            onComplete: () => {
                Object.entries(this.layoutContainers).forEach(
                    ([key, container]) => {
